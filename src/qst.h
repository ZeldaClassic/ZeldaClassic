...
int32_t readheader       (PACKFILE*, zquestheader*, byte printmetadata = 0);
int32_t readrules        (PACKFILE*, zquestheader*);
int32_t readstrings      (PACKFILE*, zquestheader*);
int32_t readdoorcombosets(PACKFILE*, zquestheader*);
int32_t readdmaps        (PACKFILE*, zquestheader*, word version, word build, word start_dmap, word max_dmaps);
int32_t readmisccolors   (PACKFILE*, zquestheader*, miscQdata *Misc);
int32_t readgameicons    (PACKFILE*, zquestheader*, miscQdata *Misc);
int32_t readmisc         (PACKFILE*, zquestheader*, miscQdata *Misc);
int32_t readitems        (PACKFILE*, word version, word build);
int32_t readweapons      (PACKFILE*, zquestheader*);
int32_t readguys         (PACKFILE*, zquestheader*);
int32_t readmapscreen    (PACKFILE*, zquestheader*, mapscr *temp_mapscr, word version, int scrind = -1);
int32_t readmaps         (PACKFILE*, zquestheader*);
int32_t readcombos       (PACKFILE*, zquestheader*, word version, word build, word start_combo, word max_combos);
int32_t readcomboaliases (PACKFILE*, zquestheader*, word version, word build);
int32_t readcolordata    (PACKFILE*, miscQdata *Misc, word version, word build, word start_cset, word max_csets);
int32_t readtiles        (PACKFILE*, tiledata *buf, zquestheader *Header, word version, word build, word start_tile, int32_t max_tiles, bool from_init);
int32_t readtunes        (PACKFILE*, zquestheader*, zctune *tunes);
int32_t readcheatcodes   (PACKFILE*, zquestheader*);
int32_t readinitdata     (PACKFILE*, zquestheader*);
int32_t readffscript     (PACKFILE*, zquestheader*);
int32_t read_one_ffscript(PACKFILE*, zquestheader*, int32_t i, word s_version, word s_cversion, script_data **script, word zmeta_version);
int32_t readsfx          (PACKFILE*, zquestheader*);
int32_t readitemdropsets (PACKFILE*, word version, word build);
int32_t readfavorites    (PACKFILE*, int32_t, word);
